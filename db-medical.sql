...
('admin@gmail.com', 'medical_admin', 'Phạm Văn Đạt', '$2a$12$34v8mMKqNaTTSgARBNE8leWz3.8dGIGQ6VKNUUeZjs3j2u4NedKL2','0978315545', 'ADMIN', 'Ha Noi', 1 ,'123'),
...
('Dầu gội chống gàu Selsun chai 100ml', 'Đánh bay nấm gây gàu, làm sạch vảy nấm và ngứa da đầu. Giữ cho da đầu không gàu, không ngứa và luôn khỏe mạnh. Có thể dùng cho cả tóc nhuộm và uốn.', 75000, 1, 99, 1 ),
('Sữa rửa mặt cho da nhạy cảm Cetaphil Gentle Skin Cleanser chai 125ml', 'Sữa Rửa Mặt Cetaphil Gentle Skin Cleanser 500ml giúp làn da cân bằng độ pH, duy trì hàng rào bảo vệ da, tránh được các tác nhân ô nhiễm từ môi trường. Sản phẩm không chứa xà phòng, không gây kích ứng da, phù hợp với mọi loại da, kể cả làn da mỏng manh cả trẻ nhỏ.', 115000, 1, 99, 1 ),
('Tuýp dưỡng ẩm môi Vaseline Pure tuýp 10g', 'Phòng chống nứt môi, khô môi, nứt da bàn chân, bàn tay. Làm mềm da và các nếp nhăn.', 12000, 1, 99, 1 ),
('Kem trị sẹo Dermatix Ultra tuýp 15g', 'Các vết sẹo có thể gây ra do nhiều nguyên nhân và tai nạn khác nhau: phẫu thuật, bỏng, vết cắt, vết cắt xước, côn trùng cắn v.v.. . Những sẹo kể trên có thể gia tăng kích thước, độ dày, trở nên khô, nổi phồng, chuyển sang màu sậm hoặc đỏ, gây ngứa và đau. Dermatix Ultra Gel có hiệu quả trên nhiều loại sẹo.', 305000, 1, 99, 1 ),
('Kem Nghệ & Vitamin Thái Dương tuýp 20g', 'Dưỡng da, giúp tái tạo tế bào da mới, ngăn ngừa vết thâm, nám, dùng cho các trường hợp: Muỗi đốt, côn trùng cắn, rôm sảy.Các vết trầy xước, vết thương nhẹ, da khô nứt nẻ.Mụn trứng cá.Ngăn ngừa nám da, nứt rạn da ở phụ nữ sau khi sinh.Bỏng da nhẹ.Nấm da (lang ben, hắc lào), thủy đậu, zona thần kinh, nước ăn tay, chân.', 15000, 1, 99, 1 ),
('Tinh Chất Dưỡng Da Mụn Some By Mi AHA-BHA-PHA 30 Days Miracle Serum 50ml', 'AHA, BHA tác động sâu giúp loại bỏ bụi bẩn, tế bào chết và làm thông thoáng lỗ chân lông. PHA khả năng tẩy dịu nhẹ nhất, giảm thiểu kích ứng da.', 289000, 1, 99, 1 ),
('Serum Dưỡng Trắng Da, Mờ Thâm, Trẻ Hóa Da, Cấp Ẩm Chuyên Sâu Và Chống Nắng ISKIN Collagen Youth Ampoule 30ml ISKIN', 'Serum trắng da ISKIN là sản phẩm cao cấp được nghiên cứu tại Hàn Quốc, đã được kiểm định nên cực kỳ an toàn cho da khi khi sử dụng. Phù hợp với mọi loại da, kể cả da nhạy cảm.', 84000, 1, 99, 1 ),
('VIÊN TINH NGHỆ SỮA ONG CHÚA', 'Sữa ong chúa là sản phẩm được tiết ra từ hàm của con thợ từ 7 ngày tuổi trở đi để nuôi ong chúa và ấu trùng ong chúa, giàu protein, các loại acid amin, lipid, vitamin thành phần khác nhau, bao gồm mật hoa, chất đạm cùng các loại vitamin và khoáng chất', 260000, 2, 99, 1 ),
('Miếng dán hạ sốt dành cho trẻ em Koolfever hộp 16 miếng', 'Koolfever hạ sốt hoàn toàn tự nhiên dựa vào cơ chế hấp thụ nhiệt từ vùng da nóng sốt và khuếch tán ra ngoài qua lỗ thông hơi trên lớp vải, giúp hạ nhiệt độ trên da khoảng 2°C.', 13900, 2, 99, 1 ),
('Tăm bông Bông Bạch Tuyết gói 42 que', 'Đầu bông 100% bông xơ tự nhiên, thân nhựa nguyên sinh. Đầu bông sản xuất từ 100% bông xơ tự nhiên, mềm mại, an toàn. Que nhựa có độ đàn hồi, chịu được nhiệt độ cao. Đạt các tiêu chuẩn về quy trình và chất lượng như ISO 9001, ISO 13485, các chứng nhận FDA, CE và Hàng Việt Nam chất lượng cao.', 4000, 2, 99, 1 ),
('Combo chăm sóc cá nhân Ecostore', 'Combo chăm sóc cá nhân Ecostore gồm: 1  chai nước rửa tay 425ml, 1 chai sữa tắm 400ml, 1 hộp bánh xà phòng 80gr', 322500, 2, 99, 1 ),
('Nước Súc Miệng LISTERINE COOL MINT Thái Lan', 'Nước súc miệng Listerine tăng khả năng diệt khuẩn vượt trội nhờ sự kết hợp của 4 loại tinh dầu: bách hương, bạc hà, bạch đàn và. Sản phẩm có khả năng tiêu diệt đến 99 % vi khuẩn, giảm đáng kể mảng bám và các bệnh viêm lợi. Súc miệng với Listerine mỗi ngày để răng luôn chắc khỏe và trắng sáng.', 105000, 2, 99, 1 ),
('Dung dịch xịt sạch thông mũi cho trẻ em Xisat chai 75ml', 'Nước biển sâu thiên nhiên tinh chiết từ độ sâu 450m giàu muối và khoáng chất như Cu2+, Zn2+ ... có tính kháng khuẩn, kháng viêm. Kết hợp với tinh dầu bạc hà giúp mũi luôn thông thoáng, dễ thở.', 28000, 2, 99, 1 ),
('Kem trị rôm sảy và ngăn ngừa mụn Yoosun Rau Má tuýp 25g', 'Cây rau má (Centella asiatica) đã được dân gian sử dụng làm bào thuốc hạ nhiệt giải độc, ngăn ngừa rôm sảy và mẩn ngứa. Ngày nay khoa học chứng minh rằng trong dịch chiết rau má còn chứa các thành phần Asiatic acid, Madecassic Acid có tác dụng kích thích lên da non làm nhanh liền các vết thương, tránh để lại sẹo.', 20000, 2, 99, 1 ),
('Miếng dán hạ sốt Béby Cooling Plaster hộp 16 miếng', 'Dùng để hạ sốt cho trẻ em. Hiệu quả làm mát liên tục trong 10 giờ nhờ miếng gel giữ ẩm cao, làm mát liên tục sau khi dán vào buổi tối đến sáng hôm sau. Hiệu quả làm mát ổn định nhờ cơ chế hấp thu và phát tán nhiệt thông qua miếng dán gel có chứa ẩm. Sử dụng loại cao phân tử ưa nước nhẹ nhàng với da. Có tính axit yếu, ít gây kích ứng da.', 16000, 2, 99, 1 ),
('Băng vệ sinh Whisper có cánh đêm 32 miếng', 'Công nghệ bảo vệ toàn diện giúp hỗ trợ ngăn ngừa các bệnh phụ khoa, viêm ngứa và các bệnh gây hại cho âm đạo. Thiết kế lõi thấm hút tối ưu giúp hút hết các dịch lỏng xuống đáy và ngăn tràn sang hai bên để bạn thoải mái ngủ với mọi tư thế...', 66500, 2, 99, 1 ),
('Nước biển xịt mũi cho trẻ sơ sinh Stérimar Nose Hygiene Baby hộp 1 chai 50ml', 'Sterimar Baby là một thiết bị y tế, vòi phun có khất bảo vệ, không gây bất kỳ tổn thương nào. Vòi phun an toàn này phù hợp cho trẻ từ 0 - 3 tuổi.', 95000, 2, 99, 1 ),
('Dung dịch xịt sạch thông mũi cho người lớn Xisat chai 75ml', 'Nước biển sâu thiên nhiên tinh chiết từ độ sâu 450m giàu muối và khoáng chất như Cu2+, Zn2+ ... có tính kháng khuẩn, kháng viêm. Kết hợp với tinh dầu bạc hà giúp mũi luôn thông thoáng, dễ thở.', 26000, 3, 99, 1 ),
('Bộ test nhanh SARS-CoV-2 TODA CORONADIAG Ag Covid Test hộp 20 bộ kit', 'Kit Test Covid Toda - Pháp - Khay Thử Xét Nghiệm Kháng Nguyên Sars Cov-2 được sản xuất tại Pháp theo tiêu chuẩn Châu Âu CE, ISO 1348, là bộ phát hiện kháng nguyên COVID-19 nhanh chóng chỉ trong 15 phút. Dụng cụ có độ nhạy lên tới 98,6%, độ đặc hiệu 100% và được Bộ Y Tế cấp phép, kiểm định chất lượng tại Viện kiểm định quốc gia vắc xin và sinh phẩm y tế.', 33000, 3, 99, 1 ),
('Bộ kit test nhanh Humasis COVID-19 Ag Test hộp 25 kit', 'Bộ kit test nhanh Humasis Covid-19 Ag Test là một bộ kit xét nghiệm của hãng Humasis đến từ Hàn Quốc. Sản phẩm này đã được Bộ Y tế cấp phép số và được chứng nhận bởi Viện Kiểm Định Quốc Gia Vắc Xin và Sinh Phẩm Y Tế trực thuộc Bộ Y tế. Bộ kit sẽ giúp nhanh chóng phát hiện định tính kháng nguyên từ SARS-CoV-2 trong mẫu tăm bông được lấy từ tỵ hầu của những đối tượng bị nghi nhiễm COVID-19.', 31000, 3, 99, 1 ),
('Nước muối sinh lí Nước Muối Vĩnh Phúc chai 1000ml', 'Phòng các bệnh răng miệng: viêm chân răng, viêm lợi, viêm họng, viêm amidan, các bệnh lây qua đường hô hấp, làm sáng da, sáng mắt... Rửa sát trùng vết thương, vết loét ở miệng, họng và ngoài da, chữa viêm xoang.', 11000, 3, 99, 1 ),
('Băng cá nhân vải độ dính cao Urgo Durable hộp 102 miếng', 'Urgo Durable có nền vải co giãn, độ dính cao trên mọi vị trí, kể cả vị trí khó. Urgo Durable có nhiều lỗ thoát khí nhỏ, giúp da thông thoáng. Gạc không dính vào vết thương, không gây đau khi thay băng', 500, 3, 99, 1 ),
...
('[NỘI ĐỊA NHẬT] Cam kết trắng bật tông, dứt điểm hôi miệng, giảm viêm nha chu 2 tuần với bột đánh răng KINBATA Nhật Bản', 'Loại bỏ mảng bám gây ố vàng, trả lại hàm răng trắng sáng đều màu. Hỗ trợ dứt điểm tình trạng hôi miệng. Ngăn ngừa sâu răng, chảy máu chân răng.', 148000, 3, 99, 1 ),
('Máy Tăm Nước cầm tay -Tăm nước vệ sinh răng miệng Cao cấp - 3 chế độ xịt Máy Chăm Sóc Răng Miệng Mini ，4 đầu tăm', 'Loại bỏ thức ăn thừa dính trên kẽ răng hiệu quả, nhanh chóng, những vị trí khó (răng hàm, răng khôn, răng mọc lệch) mà bàn chải đánh răng hay chỉ nha khoa không làm sạch được. Làm sạch tận sâu trong kẽ răng, giảm tình trạng sâu răng. Phù hợp: người hay đi làm, muốn mang theo 1 sản phẩm gọn nhẹ đi theo, người niềng răng, bọc sứ, trám răng, viêm lợi...', 113000, 3, 99, 1 ),
('Máy xông hút 2in1 AG LIFE model mới nhất chính hãng cao cấp', ' Tính năng HÚT DỊCH MŨI: Giảm ho, đờm, sổ mũi, ngạt mũi, khó thở, thở khò khè ở trẻ. Hút sạch sâu tận bên trong khoang mũi. Làm sạch mũi, loại bỏ bụi bẩn, vi khuẩn, virus nấm mốc', 1150000, 3, 99, 1 ),
('Máy đo huyết áp điện tử Yamada công nghệ Nhật Bản – Trợ lý ảo giọng nói Tiếng Việt thông minh', 'Chức năng Assistant+ độc quyền duy nhất tại Việt Nam: hướng dẫn đo, đọc kết quả đo, thông báo tình trạng sức khỏe, đưa ra lời khuyên... bằng Tiếng Việt. Theo dõi sức khỏe cả gia đình nhanh chóng và đơn giản. Sản phẩm có độ chính xác cao, đã được kiểm nghiệm lâm sàng tại Mỹ và Châu Âu.', 669000, 3, 99, 1 ),
('Tinh dầu hoa anh thảo Blackmore Evening Primrose Oil 1000 đẹp da, cân bằng nội tiết tố lọ 190v', 'Sản phẩm: Tinh dầu hoa anh thảo Blackmore Evening Primrose Oil 1000. Chăm sóc mụn trứng cá, Chống lão hóa, Collagen, Làm trắng. Người lớn: uống 1-3 viên nang một ngày hoặc theo chỉ dẫn của bác sỹ.', 496000, 4, 99, 1 ),
('Tinh chất hàu New Zealand Good Health Oyster Plus tăng cường sinh lý nam giới hộp 60v', 'Tinh chất hàu Oyster Plus chứa các dưỡng chất thiết yếu như: Kẽm, các vitamin, khoáng chất và acid amin từ Hàu biển New Zealand trong lành nhất thế giới; giúp hỗ trợ tăng cường sức khỏe và sinh lực nam giới bền bỉ, dẻo dai.Khả năng miễn dịch, Vitmin tổng hợp và khoáng chất, Thực phẩm dinh dưỡng và đồ uống', 429000, 4, 99, 1 ),
('Viên uống Solgar Male Multiple - Giúp Tăng Cường Miễn Dịch, Giảm Stress, Chuyển Hóa Năng Lượng [Lọ 60 Viên]', 'Sản phẩm dành cho nam giới giúp chuyển hóa năng lượng,Giảm StressTim mạch & huyết áp... Khả năng miễn dịch, Vitmin tổng hợp và khoáng chất, Căng thẳng, giấc ngủ, và nlo lắng', 1200000, 4, 99, 1 ),
